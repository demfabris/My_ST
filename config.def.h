 ...
 */
/* static char *font = "Ubuntu Mono Nerd Font:size=16:antialias=true:autohint=true"; */
static char *font = {"Fantasque Sans Mono Nerd Font:size=14:antialias=true:autohint=true" };
